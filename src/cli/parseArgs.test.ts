...
describe('parseArgs', () => {
  it('parses default output and no exclusions', () => {
  ...
  it('parses custom output option', () => {
  ...
  it('parses exclude extensions with leading dot', () => {
  ...
  it('parses exclude extensions without leading dot', () => {
  ...
  it('parses exclude paths correctly', () => {
    const argv = [
      'node',
      'app.js',
      'folder',
  ...
  it('throws error when no input paths provided', () => {
